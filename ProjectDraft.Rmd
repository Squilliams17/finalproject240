...
10.2-point FG% vs. WIN%: r = 0.28, p ≈ 0.31 (not statistically significant)

These results suggest that three-point shooting efficiency—rather than raw 2-point or 3-point shot volume is a more reliable predictor of playoff success. Among the three-point zones, above-the-break threes show the strongest and statistically significant correlation with win percentage, while corner threes show moderate but less significant correlations, as also visualized in the earlier graphs.

In contrast, raw made field goals (2-point or 3-point) and the difference between 2-point and 3-point attempts appear less critical in explaining team success, as they do not strongly correlate with win percentage. Additionally, the weak correlation between 2-point and 3-point FGM indicates that while teams may favor one type of shot over another, this specialization alone does not strongly predict playoff outcomes. Overall, this analysis supports the original hypothesis that three-point efficiency matters more than two-point efficiency in determining team success in the playoffs

For future research, analyzing a full regular-season dataset could determine whether these trends extend beyond the playoffs or other trends may appear. Investigating shot timing, such as clutch three-pointers versus routine two-point attempts, may provide deeper insight into how strategic shot selection affects win probability in high-stakes moments.
